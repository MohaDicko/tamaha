        ...
        <>
            ...
            {!isOpen && (
                <motion.button
                    ...
                    className="fixed bottom-6 right-6 z-[100] flex h-14 w-14 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-xl transition-colors"
                >
                    <Bot size={28} />
                </motion.button>
            )}
